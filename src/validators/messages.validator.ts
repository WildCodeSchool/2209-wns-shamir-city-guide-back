...
export enum CommonErrorValidator {
  ...
  NAME_TOO_SHORT = "La longueur du nom est trop courte. La longueur minimale est de 1 caractère",
...
export enum RoleErrorValidator {
  ...
  NAME_TOO_SHORT = "La longueur du nom du rôle est trop courte. La longueur minimale est de 1 caractère",
...
export enum UserErrorValidator {
  ...
  USERNAME_TOO_SHORT = "La longueur du nom de l'utilisateur est trop courte. La longueur minimale est de 1 caractère",
  ...
  PASSWORD_WRONG_FORMAT = "Le format du mot de passe est incorrect, il faut au moins une majuscule, une minuscule, un chiffre et un caractère spécial. De plus sa longueur doit être de 8 caractères minimum",
}
...
export enum CityErrorValidator {
  ...
  NAME_TOO_SHORT = "La longueur du nom de la ville est trop courte. La longueur minimale est de 1 caractère",
...
export enum TypeErrorValidator {
  ...
  NAME_TOO_SHORT = "La longueur du nom du type est trop courte. La longueur minimale est de 1 caractère",
...
export enum TagErrorValidator {
  ...
  NAME_TOO_SHORT = "La longueur du nom du tag est trop courte. La longueur minimale est de 1 caractère",
...
export enum CategoryErrorValidator {
  ...
  NAME_TOO_SHORT = "La longueur du nom de la catégorie est trop courte. La longueur minimale est de 1 caractère",
