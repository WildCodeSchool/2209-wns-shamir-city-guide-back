...
test('StringUtils.retrieveKeyFromDbErrorMessage : Drop the property which has to be unique in database from the error message', () => {
...
test('StringUtils.formatString : Convert a string xxxxx to Xxxxx', () => {
